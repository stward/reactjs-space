...
Next, create your app. To do this, from the command line run `create-react-app reactjs-space` in the directory of your choice. cd into `react-space`, run `npm start`, and the app is off and running. Or if you don't want to build this thing from scratch (and this is definitely the better option), just clone this repository from GitHub.
